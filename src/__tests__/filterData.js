...
describe('Test filter', () => {
    it('multiple', () => {
        const filters = [
            ...
            {prop: 'A', value: ['Y', 'Z'], operator: 'AND', negated: true, expected: [3, 4]},
            {prop: 'A', value: ['Z', 'Y'], operator: 'OR', negated: true, expected: [0, 1, 3, 4]},
    ...
    it('value', () => {
        const filters = [
            ...
            {prop: 'B', value: ['X', 'Y'], operator: 'AND', negated: true, expected: [1, 4]},
            {prop: 'B', value: ['X', 'Y'], operator: 'OR', negated: true, expected: [0, 1, 2, 3, 4]},
